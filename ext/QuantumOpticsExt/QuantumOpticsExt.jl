...
const _rotx(g::RotXGate) = cos(g.θ/2)*_id - im*sin(g.θ/2)*_x
const _roty(g::RotYGate) = cos(g.θ/2)*_id - im*sin(g.θ/2)*_y
const _rotz(g::RotZGate) = cos(g.θ/2)*_id - im*sin(g.θ/2)*_z
